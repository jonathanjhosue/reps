    ...
    $.fn.jPaginate = function(options) {
        ...
        this.each(function() {
            ...
            function showPage(page) {
                ...
                if(typeof array_of_elements[page] !== 'undefined'){
            ...
            function createPagination(curr) {
                ...
                start = "<ul class='pagination "+options.pagination_class+"'>";
...
((expiredays==null)?"":";expires="+exdate.toUTCString());
            ...
            $("."+options.pagination_class+" .goto").live("click", function(e){
                e.preventDefault();
             ...
             $("."+options.pagination_class+" .goto_next").live("click", function(e) {
                e.preventDefault();
                var act = "."+options.active;
                var newcurr = parseInt(obj.next(".pagination").find(".active").attr("title")) + 1;
                set_cookie( "current", newcurr);
				showPage(newcurr);
                $("."+options.pagination_class).remove();
                //obj.next(".pagination").remove();
                //obj.next("br").remove();
                createPagination(newcurr);
            });
             $("."+options.pagination_class+" .goto_previous").live("click", function(e) {
                e.preventDefault();
                var act = "."+options.active
