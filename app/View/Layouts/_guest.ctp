...
<head>
	...
	<?php
		...
		echo $html->css('cake.cms_pageNav.css');
...
<body>
	<div id="container">
		<div id="header">
			<h1 style="float:left;"><?php echo $html->link(__('PanamaReps: Product Catalogue', true), '../'); ?></h1>
			<div style="float:right;">
				<?php 	
					if(isset($_SESSION['Auth']['User'])){ 
							echo $html->link($html->image('_log_out.png', array('alt' => 'Login', 'width'=>'15%')), array('controller' => 'users', 'action' => 'logout'), array('escape'=>false)); 
						}else{ echo $html->link($html->image('_log_in.png', array('alt' => 'Login', 'width'=>'15%')), array('controller' => 'users', 'action' => 'login'), array('escape'=>false)); }
				?>
				&nbsp;&nbsp;					
		...
		<div id="content"> <!-- este es el pagecell1 del template-->	
			<?php //echo $this->element('pageNavGuest');					
