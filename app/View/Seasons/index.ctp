<div class="seasons index">
	...
	<tr>
		...
		<td><?php echo h($season['Season']['date_start']); ?>&nbsp;</td>
		<td><?php echo h($season['Season']['date_end']); ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($season['Product']['product_name'], array('controller' => 'hotels', 'action' => 'view', $season['Hotel']['id'])); ?>
		</td>
		<td class="actions">
