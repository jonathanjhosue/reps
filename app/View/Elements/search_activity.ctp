<form id="FormSearch" method="post">
    ...
    <fieldset id="filter">
       ...
       <?php $categorias= $this->requestAction('ActivityTypes/index'); ?>
       <ul class="filter" >
           <li class="<?php echo $selectCategory==null?"active":"" ?>"> <?php echo $this->Paginator->link('None',array('category' => null)) ?></li>
           <?php foreach ($categorias as $categoria): ?>
           <li class="<?php echo $selectCategory==$categoria['ActivityType']['id']?"active":"" ?>">                
               <?php echo $this->Paginator->link($categoria['ActivityType']['activity_type_name'],array('category' => $categoria['ActivityType']['id'])); ?> 
           </li>
         <?php endforeach; ?>           
       </ul>
     </fieldset>
