...
<div class="hotels form">
	<?php echo $form->create('Hotel', array('action' => 'edit')); ?>
	<fieldset>
		<legend>Edit Hotel</legend>
		<?php echo $form->input('Hotel.id', array('type'=>'hidden'));
...
<div class="actions">
	<ul>
		<li>
			<?php echo $html->link('Delete', array('controller'=>'hotels', 'action'=>'delete', $form->value('Product.id')), null, 'Are you sure you want to delete this Hotel?'); ?>
		</li>			
