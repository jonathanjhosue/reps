<div class="vehicles index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($vehicle['Rentacar']['Product']['product_name'], array('controller' => 'rentacars', 'action' => 'admin_edit', $vehicle['Rentacar']['product_id'])); ?>
		</td>
                <td>
			<?php echo $this->Html->link($vehicle['VehicleCategory']['name'], array('controller' => 'vehicleCategories', 'action' => 'admin_index', $vehicle['VehicleCategory']['id'])); ?>
		</td>
                <td>
			...
			<?php echo $this->Html->link($vehicle['Vehicle']['type'], array('controller' => 'vehicles', 'action' => 'admin_edit', $vehicle['Vehicle']['product_id'])); ?>
                ...
                <td>
			<?php echo $this->Html->link($vehicle['Vehicle']['fuel'], array('controller' => 'vehicles', 'action' => 'admin_edit', $vehicle['Vehicle']['product_id'])); ?>
		</td>
