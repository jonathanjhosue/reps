 ...
 */
class ShoppingCarsController extends AppController {
 ...
 public $helpers = array('Html', 'Form');
    ...
    public $paginate = array(
     ...
     public function addVehicle() {
       ...
       $view = new View($this);
        $ripsHelper = $view->loadHelper('RipsWeb');
         $dateinicio= $ripsHelper->getStringFromDate($this->request->data['ShoppingVehicle']['pickup_date']);
         $datefinal= $ripsHelper->getStringFromDate($this->request->data['ShoppingVehicle']['dropoff_date']);
         $idproduct=$this->request->data['ShoppingVehicle']['product_id'];
        
        
        $result= $this->ShoppingCar->getRateByDate($dateinicio,$datefinal,$idproduct);
        
         $this->set('xx',$this->request->data);
	...
	{	
		...
		//$language = $this->Session->read('language');
			...
			throw new NotFoundException(__('Invalid Vehicle'));
                ...
                $this->Vehicle->Product->setLocale($language);
                //$this->Vehicle->setLocale($language);
